...
| Audit query, resumable event delivery, webhooks, exports, MCP application interface                  | Partial foundations with a stateless MCP Streamable HTTP endpoint on the API; several production adapters and workers are still planned                                                                                                                 |
