...
| Gateway identity, enrollment, CloudLink sessions, manifests, telemetry, alarms                       | Production Fleet list/detail/registration API and console are implemented over Supabase PostgreSQL; enrollment claims, production CloudLink, history, and alarms remain partial foundations                                                             |
