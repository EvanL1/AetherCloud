...
| Audit query, resumable event delivery, webhooks, exports, MCP application interface                  | Supabase ES256 JWT-authenticated PostgreSQL Audit JSON/SSE, the bilingual AetherWebsite account page, and stateless MCP HTTP are implemented; membership provisioning, live delivery, several adapters, and workers remain planned                      |
